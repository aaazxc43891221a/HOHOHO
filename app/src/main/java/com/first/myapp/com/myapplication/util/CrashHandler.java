...
//        Intent bleLogoutIntent = new Intent(BluetoothLeService.USER_LOGOUT);
//        mContext.sendBroadcast(bleLogoutIntent);
        //使用Toast来显示异常信息
        new Thread() {
            @Override
            public void run() {
...
//                e.printStackTrace();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        sb.append(result);
        LogUtil.log(LogUtil.LogLevel.ERROR,TAG,sb.toString());
        try {
